...
set top_module_name "vec_tb_top";
set git_root        [exec git rev-parse --show-toplevel];
set module_path     $git_root/modules/synchronizers/cdc_vector_sync;
set script_dir      [pwd]
...
set rtl_directories [list \
  "$git_root/modules/synchronizers/cdc_bit_sync/rtl" \
  "$git_root/modules/synchronizers/cdc_vector_sync/rtl" \
  "$module_path/rtl"];
...
set tb_files [list \
  "$module_path/tb/vec_tb_pkg.sv" \
  "$module_path/tc/vec_tc_pkg.sv" \
  "$module_path/tb/vec_tb_top.sv"];
...
exec xelab vec_tb_top -v 2 -debug all -relax -s top -timescale 1ns/1ps
