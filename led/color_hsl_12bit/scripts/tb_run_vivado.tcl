...
set top_module_name "hsl_tb_top"
set git_root        [exec git rev-parse --show-toplevel]
set module_path     $git_root/led/color_hsl_12bit
set script_dir      [pwd]
...
exec xelab hsl_tb_top -debug all -relax -s top -timescale 1ns/1ps

# Debug, verbosity set to highest
#exec xelab -v 2 hsl_tb_top -debug all -relax -s top -timescale 1ns/1ps
