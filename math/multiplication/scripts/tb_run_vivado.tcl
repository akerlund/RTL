...
set top_module_name "mul_tb_top";
set git_root        [exec git rev-parse --show-toplevel];
set module_path     $git_root/math/multiplication
set script_dir      [pwd]
...
set tb_files [list \
  "$module_path/tb/mul_tb_pkg.sv" \
  "$module_path/tc/mul_tc_pkg.sv" \
  "$module_path/tb/mul_tb_top.sv"];
...
exec xelab mul_tb_top -debug all -s top -timescale 1ns/1ps
